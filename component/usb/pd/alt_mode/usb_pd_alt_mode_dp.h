...
{
    /*! USB r2.0 signaling may be required on A6 - A7 or B6 - B7 while in DisplayPort Configuration */
    kUSB2_Required = 0,
    /*! USB r2.0 signaling is not required on A6 - A7 or B6 - B7 while in DisplayPort Configuration */
    kUSB2_NotRequired = 1,
