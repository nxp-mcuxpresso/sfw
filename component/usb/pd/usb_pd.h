...
/**
 * @brief Alternate Mode Adapter VDO
 */
...
typedef enum _pd_product_type_ufp_t
{
    ...
    kProductTypeUfp_AMA, /* Alternate Mode Adapter */
...
typedef enum _pd_product_type_dfp_t
{
    ...
    kProductTypeDfp_AMA, /* Alternate Mode Adapter */
} pd_product_type_dfp_t;

/**
 * @brief Alternate Mode Adapter VDO Field, used in the #_pd_ama_vdo_t
 */
 ...
 * @brief Alternate Mode Adapter VDO Field, used in the #_pd_ama_vdo_t
 */
typedef enum _pd_usb_super_speed_signal_t
{
    kUsbSuperSpeedSiganl_Usb20Only,
    kUsbSuperSpeedSiganl_Usb20Gen1,
    kUsbSuperSpeedSiganl_Usb20Gen1Gen2,
    kUsbSuperSpeedSiganl_Usb20BillboardOnly,
} pd_usb_super_speed_signal_t;
