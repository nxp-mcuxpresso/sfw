...
typedef enum tTimer
{
    ...
    tDRPTryWaitTimer             = 34,
    tDRPTryTimer                 = 35,
    tBISTContModeTimer           = 36,
    tFRSwapSignalTimer           = 37,
    tVBUSONTimer                 = 38,
    timrChunkSenderResponseTimer = 39,
    timrChunkSenderRequestTimer  = 40,
    timrMsgSendWaitResultTimer   = 41,
    timrFRSwapWaitPowerStable    = 42,
    tDiscoverIdentityTimer       = 43,
    tTimerCount                  = 44,
    _tEnd                        = tTimerCount - 1,
...
#define PD_MAX_TIMER_COUNT (44U)

#define T_FRSWAP_WAIT_POWER_STABLE (50)
