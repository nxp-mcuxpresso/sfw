...
typedef struct _usb_audio_2_0_ctrl_ot_desc
{
    ...
    uint8_t bterminalid; /*!< Constant uniquely identifying the Terminal within the audio function. This value is used
                            in all requests to address this Terminal*/
    uint8_t wterminaltype[2]; /*!< Constant characterizing the type of Terminal*/
    uint8_t bassocterminal;   /*!< IConstant, identifying the Input Terminal to which this Output Terminal is associated.*/
...
typedef struct _usb_audio_2_0_stream_spepific_as_intf_desc
{
    ...
    uint8_t bmFormats[4]; /*!< The Audio Data Format(s) that can be used to communicate with this interface. See the USB Audio Data Formats document for further details*/
 ...
 * @deprecated Do not use this function. It has been superceded by @ref USB_HostAudioStreamGetCurrentAltsettingSpecificDescriptors.
 *
 ...
 * @param DescriptorSubType         The descriptor subtype, 0 for no subtype, for standard endpoint , 0 stand for data endpoint.
 ...
 * @param cmdCode          The bRequest code in lower 8bit of lower word and get feature(1)/set feature(0) flag in higher 8bit of lower word.
 * @param buf              The feature unit request buffer pointer.
 * @param callbackFn       This callback is called after this function completes.
 * @param callbackParam  The first parameter in the callback function.
 *
 ...
 * @param classHandle      The class handle.
 * @param csAndCn          The CS and CN or MCN for wValue field in setup Request.
 * @param cmdCode          The bRequest code in lower 8bit of lower word and get clock(1)/set clock(0) flag in higher 8bit of lower word.
 * @param buf              The feature unit request buffer pointer.
 * @param callbackFn       This callback is called after this function completes.
 * @param callbackParam  The first parameter in the callback function.
 *
 ...
 * @param cmdCode          The bRequest code in lower 8bit of lower word and get(1)/set(0) flag in higher 8bit of lower word.
 * @param buf              The feature unit request buffer pointer.
