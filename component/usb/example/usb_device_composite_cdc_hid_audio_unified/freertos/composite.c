...
static usb_device_class_config_list_struct_t g_UsbDeviceCompositeConfigList = {
    ...
    USB_DeviceCallback,
    sizeof(g_CompositeClassConfig) / sizeof(g_CompositeClassConfig[0]),
};
...
void APPInit(void)
{
    ...
    else
    {
        ...
        g_composite.hidKeyboard.hidHandle            = g_UsbDeviceCompositeConfigList.config[1].classHandle;
        g_composite.audioUnified.audioRecorderHandle = g_UsbDeviceCompositeConfigList.config[2].classHandle;
        g_composite.audioUnified.audioSpeakerHandle  = g_UsbDeviceCompositeConfigList.config[3].classHandle;
