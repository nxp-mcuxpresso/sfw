...
#if (((defined(USB_DEVICE_CONFIG_LPCIP3511HS) && (USB_DEVICE_CONFIG_LPCIP3511HS > 0)) || (defined(USB_DEVICE_CONFIG_EHCI) && (USB_DEVICE_CONFIG_EHCI > 0))) \
      && (USB_DEVICE_WORKAROUND_AUDIO_20_WINDOWS > 0))
#error "please set macro USB_DEVICE_WORKAROUND_AUDIO_20_WINDOWS 0"
#endif
...
#define USB_DEVICE_INTERFACE_COUNT (6)
...
#define USB_HID_KEYBOARD_ENDPOINT (2)
...
#define USB_CDC_VCOM_CIC_INTERFACE_INDEX (4)
#define USB_CDC_VCOM_DIC_INTERFACE_INDEX (5)
