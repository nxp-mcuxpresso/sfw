...
usb_device_class_config_struct_t g_UsbDeviceCcidConfig[1] = {
    {
        USB_DeviceCcidCallback,
        (class_handle_t)NULL,
        &g_UsbDeviceCcidClass,
    },
};

/* CCID Config list */
usb_device_class_config_list_struct_t g_UsbDeviceCcidConfigList = {
    g_UsbDeviceCcidConfig,
    USB_DeviceCallback,
    1U,
};
...
static usb_status_t USB_DeviceCallback(usb_device_handle handle, uint32_t event, void *param)
{
    ...
    switch (event)
    {
        case kUSB_DeviceEventBusReset:
        {
            ...
            g_UsbDeviceCcidSmartCard.powerOn              = 0U;
            g_UsbDeviceCcidSmartCard.currentConfiguration = 0U;
    ...
    (defined(USB_DEVICE_CONFIG_LPCIP3511HS) && (USB_DEVICE_CONFIG_LPCIP3511HS > 0U))
        ...
        case kUSB_DeviceEventSetConfiguration:
            ...
            else if (USB_DEVICE_CCID_SMART_CARD_CONFIGURE_INDEX == (*temp8))
            {
