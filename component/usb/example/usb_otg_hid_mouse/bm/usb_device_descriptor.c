...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    USB_SHORT_GET_LOW(USB_DESCRIPTOR_LENGTH_CONFIGURE + USB_DESCRIPTOR_LENGTH_INTERFACE + USB_DESCRIPTOR_LENGTH_HID +
                      USB_DESCRIPTOR_LENGTH_ENDPOINT + USB_DESCRIPTOR_LENGTH_OTG_DESCRIPTOR),
    USB_SHORT_GET_HIGH(
        USB_DESCRIPTOR_LENGTH_CONFIGURE + USB_DESCRIPTOR_LENGTH_INTERFACE + USB_DESCRIPTOR_LENGTH_HID +
        USB_DESCRIPTOR_LENGTH_ENDPOINT +
        USB_DESCRIPTOR_LENGTH_OTG_DESCRIPTOR), /* Total length of data returned for this configuration. */
    ...
    */
    ...
    USB_DESCRIPTOR_LENGTH_OTG_DESCRIPTOR, USB_DESCRIPTOR_TYPE_OTG,
    USB_DESCRIPTOR_OTG_ATTRIBUTES_SRP_MASK | USB_DESCRIPTOR_OTG_ATTRIBUTES_HNP_MASK,
