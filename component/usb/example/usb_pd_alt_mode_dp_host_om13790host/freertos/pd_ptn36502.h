...
#define REG_DP_LINK_CONTROL 0x06
...
#define REG_SQUELCH_THRESHOLD 0x0C
#define REG_DEVICE_CONTROL 0x0D
...
#define REG_MODE_CONTROL1_AUX_CROSSBAR_SWITCH_SHIFT (3)
#define REG_MODE_CONTROL1_AUX_MONITOR_POLARITY_MASK (0x10u)
#define REG_MODE_CONTROL1_AUX_MONITOR_POLARITY_SHIFT (4)
