 ...
 */
#define PD_CONFIG_ALT_MODE_SLAVE_SUPPORT (1)
 ...
 * 1 - Low power level 1. When detecting the detached state, PD PHY enters low power state.
 * 2 - Low power level 2. Include level 1 setting and Vbus functions are disabled in the attached state.
 *     Can proceed to PD communicaton and partner's message can wake up self.
 */
#define PD_CONFIG_PHY_LOW_POWER_LEVEL (2)
