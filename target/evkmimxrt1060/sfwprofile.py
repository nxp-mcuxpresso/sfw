...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -lm -lgcc -lc' + ' -Wl,--gc-sections,-Map=build/sfw.map,-cref,-u,Reset_Handler -T board/link/.MIMXRT1062xxxxx_flexspi_nor_cpp.ld'
    PRE_ACTION = CPP + ' -E -P -I . board/link/MIMXRT1062xxxxx_flexspi_nor.ld' + ' -O board/link/.MIMXRT1062xxxxx_flexspi_nor_cpp.ld\n'
