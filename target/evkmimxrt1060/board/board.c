...
void BOARD_ConfigMPU(void)
{
    ...
    extern uint32_t __base_RAM3;
    uint32_t nonCacheStart = (uint32_t)(&__base_RAM3);
    uint32_t size          = 0;
    ...
    /* Region 10 setting: Memory with Normal type, not shareable, outer/inner write back, for ROM BY SAWYER */
    MPU->RBAR = ARM_MPU_RBAR(10, 0x00200000U);
    MPU->RASR = ARM_MPU_RASR(0, ARM_MPU_AP_FULL, 0, 0, 1, 1, 0, ARM_MPU_REGION_SIZE_128KB);  
