...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -lm -lgcc -lc' + ' -Wl,--gc-sections,-Map=build/sfw.map,-cref,-u,Reset_Handler -T board/link/.LPC55S69_cm33_core0_flash_cpp.ld'
    PRE_ACTION = CPP + ' -E -P -I . board/link/LPC55S69_cm33_core0_flash.ld' + ' -O board/link/.LPC55S69_cm33_core0_flash_cpp.ld\n'
