...
if PLATFORM == 'gcc':
    ...
    DEVICE = ' -mcpu=' + CPU + ' -mthumb -specs=nosys.specs -mfpu=fpv5-d16 -mfloat-abi=hard -ffunction-sections -fdata-sections --specs=nano.specs'
    CFLAGS = DEVICE + ' -Wall -D__FPU_PRESENT'
    AFLAGS = ' -c' + DEVICE + ' -x assembler-with-cpp -Wa,-mimplicit-it=thumb '
    LFLAGS = DEVICE + ' -lm -lgcc -lc' + ' -Wl,--gc-sections,-Map=build/sfw.map,-cref,-u,Reset_Handler -T board/link/.MIMXRT595Sxxxx_cm33_flash_cpp.ld'
    PRE_ACTION = CPP + ' -E -P -I . board/link/MIMXRT595Sxxxx_cm33_flash.ld' + ' -O board/link/.MIMXRT595Sxxxx_cm33_flash_cpp.ld\n'
