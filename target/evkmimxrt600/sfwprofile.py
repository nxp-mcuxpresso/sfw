...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -lm -lgcc -lc' + ' -Wl,--gc-sections,-Map=build/sfw.map,-cref,-u,Reset_Handler -T board/link/.MIMXRT685Sxxxx_cm33_flash_cpp.ld'
    PRE_ACTION = CPP + ' -E -P -I . board/link/MIMXRT685Sxxxx_cm33_flash.ld' + ' -O board/link/.MIMXRT685Sxxxx_cm33_flash_cpp.ld\n'
